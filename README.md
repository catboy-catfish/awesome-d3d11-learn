...
- [Jason Zink, Matt Pettineo: Practical Rendering and Computation with Direct3D 11, 2011](https://www.amazon.com/Practical-Rendering-Computation-Direct3D-11/dp/1568817207) see Note 12.
...
# Notes
0. This article is where most of the links came from.
...
4. Very comprehensive, but uses a lot of weird C++ practices, code structuring decisions and design choices. Previously required the obsolete DirectX SDK, but it has recently been updated to remove that requirement and upgrade the project to Visual Studio 2022.
...
8. They have explanations, but I haven't found the source code yet.
9. Free ebook. Requires Visual Studio 2012 in order to follow. The ebook can either be downloaded or read online.
10. Highest price: $49.99 paperback. Quite old, code may not work on modern systems like Windows 10/11 or Visual Studio 2019/2022. It also requires the obsolete effects framework, however there's a more up-to-date version of the codebase at d3dcoder.net
11. Highest price: $179.32 paperback. Also relies on outdated tools and doesn't show the entire code of each sample, however [the companion site](https://bitbucket.org/pvarcholik/real-time-3d-rendering-with-directx-and-hlsl/src/master/) provides more up-to-date code samples that should compile with Visual Studio 2019.
12. Highest price: $170.00 hardcover.
13. Highest price: $54.99 paperback.
14. Highest price: $39.99. Outdated, uses Visual Studio 2010 but also contains a chapter for converting to Visual Studio 2012.
15. Example implementation of ImGui into a Win32 DirectX 11 application.
16. Archive of the repository for Joseph Whittington's tutorial.
...
21. Tutorial series on setting up runtime-compiled-C++ to use ImGui with DirectX 11.
22. Focuses a lot more on the explanation but does some coding as well. Warning that tons of the code was written intentionally before recording, an example of which being episode 4 "Window Messages".
23. Seemingly abandoned.
24. The way daivuk does things is rather simplistic, so I doubt you would learn anything crazy advanced from his series.
25. Uses the DirectXTK (DirectX Toolkit.)
